...
(function () {
    ...
    function renderPage(doc) {
        ...
        if (doc.coverImage) {
            ...
            frame.innerHTML = '<img src="' + escapeHTML(doc.coverImage) + '" alt="' + escapeHTML(doc.titleKr || doc.title) + '" referrerpolicy="no-referrer" onerror="this.parentElement.innerHTML=\'<div class=cover-placeholder><span class=cover-label>이미지를 불러올 수 없습니다</span></div>\'">';
        }
