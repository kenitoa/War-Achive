...
(function () {
    ...
    // 카테고리 정보
    var categoryInfo = {
        melee:     { title: '근접 무기',      icon: '../../Style/Image/weapons/melee.svg',     files: ['gladius', 'katana', 'longsword', 'pilum'] },
        ranged:    { title: '원거리 무기',    icon: '../../Style/Image/weapons/ranged.svg',    files: ['english longbow', 'crossbow', 'yumi'] },
        firearms:  { title: '화기',          icon: '../../Style/Image/weapons/firearms.svg',  files: ['ak-47', 'm16', 'stg44', 'bar m1918'] },
        artillery: { title: '포병 / 폭발물', icon: '../../Style/Image/weapons/artillery.svg', files: ['katyusha', 'm101 howitzer', 'v-2 rocket'] },
        armor:     { title: '기갑 / 차량',   icon: '../../Style/Image/weapons/armor.svg',     files: ['m4 sherman', 'tiger i', 't-34'] },
        aircraft:  { title: '항공기',        icon: '../../Style/Image/weapons/aircraft.svg',  files: ['p-51 mustang', 'spitfire', 'bf109'] },
        naval:     { title: '함선',          icon: '../../Style/Image/weapons/naval.svg',     files: ['geobukseon', 'hms dreadnought', 'type vii u-boat'] },
        defense:   { title: '방어 장비',     icon: '../../Style/Image/weapons/defense.svg',   files: ['plate armor', 'roman scutum', 'samurai armor'] }
    };
