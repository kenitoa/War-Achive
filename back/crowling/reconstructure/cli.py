...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--database", type=Path, default=Path("back/crowling/data/raw-crawling.sqlite3"))
    parser.add_argument("--front-data", type=Path, default=Path("front/data"))
